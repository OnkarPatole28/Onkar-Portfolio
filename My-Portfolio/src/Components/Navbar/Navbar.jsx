  ...
  return (
    <div className='navbar'>
      ...
      <div className="nav-social-icons">
        <a href="https://www.linkedin.com/in/onkarpatole" target="_blank" rel="noopener noreferrer">
          <img src={linkedin} alt="LinkedIn" />
        </a>
        <a href="https://github.com/OnkarPatole28" target="_blank" rel="noopener noreferrer">
          <img src={github} alt="GitHub" />
        </a>
        <a href="https://instagram.com/_onkar28" target="_blank" rel="noopener noreferrer">
